...
<div class="page-content">
    ...
    <nav class="page-breadcrumb">
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href='qrcode'>QRcode</a></li>
                ...
                <div class="card-body">
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center">
                            <a href="{{ url('admin/qrcode/add') }}" class="btn btn-sm btn-success">Add QRcode</a>
                        </div>
                    </div>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        @if(!empty($value->product_code))
                                            {!! DNS2D::getBarcodeHTML($value->product_code, 'QRCODE', 2, 2) !!}
                                    ...
                                    <td class="text-center" style="width: 50px;">
                                        <a href="{{ url('admin/qrcode/edit/' . $value->id) }}" class="dropdown-item align-items-center">
