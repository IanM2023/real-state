<nav class="sidebar">
    ...
    <div class="sidebar-body">
        ...
        <li class="nav-item @if(Request::segment(2) == 'color') active @endif">
        ...
        <li class="nav-item @if(Request::segment(2) == 'qrcode') active @endif">
        ...
        <li class="nav-item @if(Request::segment(2) == 'smtp') active @endif">
