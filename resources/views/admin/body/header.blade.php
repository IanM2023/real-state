        ...
        <div class="flex-grow-1 me-2">
            ...
            <li class="nav-item dropdown">
                <a class="nav-link dropdown-toggle" href="#" id="profileDropdown" role="button" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                  ...
                  <img src="{{ asset('upload/' . Auth::user()->photo) }}" alt="" class="wd-30 ht-30 rounded-circle">
                  @else
                  <img src="upload/default_image.jpg" alt="User Photo" class="wd-30 ht-30 rounded-circle">
                @endif
                </a>
                <div class="dropdown-menu p-0" aria-labelledby="profileDropdown">
                    <div class="d-flex flex-column align-items-center border-bottom px-5 py-3">
                        <div class="mb-3">
                          @if (!empty(Auth::user()->photo))
                            <img src="{{ asset('upload/' . Auth::user()->photo) ?? '' }}" alt="" class="wd-80 ht-80 rounded-circle">
                          @endif
                        </div>
                    ...
                    <ul class="list-unstyled p-1">
                      ...
                      <li class="dropdown-item py-2">
                        <a href="{{ url('admin/profile/change-pass') }}" class="text-body ms-0">
