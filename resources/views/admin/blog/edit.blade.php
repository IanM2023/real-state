            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ url('admin/blog/edit/' . $getRecord->id) }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="title" class="form-control" placeholder="Enter Title Name" value="{{ old('title', $getRecord->title) }}" required id="getTitle">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <input type="text" name="slug" class="form-control" placeholder="Enter Slug Name" value="{{ old('slug', $getRecord->slug) }}"  required id="getSlug">
...
@section('script')
    <script type="text/javascript">
            ...
            $('body').on('click', '#ConvertSlug', function () {
