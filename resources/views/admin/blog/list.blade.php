                    ...
                    <div class="d-flex justify-content-between align-items-center flex-wrap">
                        ...
                        <div class="d-flex align-items-center mb-4" style="gap: 10px;">
                            <form method="GET" action="{{ url()->current() }}" class="d-flex align-items-center mb-4" style="gap: 10px; flex-wrap: wrap;">
                                ...
                                <a href="{{ url('admin/blog/add') }}" class="btn btn-sm btn-success">Add New Blog</a>
                            </form>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered">
                            <thead>
                                <tr>
                                    ...
                                    <th>Description</th>
                                    <th>Date Created</th>
                                    <th colspan="3" class="text-center" style="width: 150px;">Action</th>
                                </tr>
                            </thead>
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td class="text-center" style="width: 50px;">
                                        <a href="{{ url('admin/blog/edit/' . $value->id) }}" class="dropdown-item align-items-center">
                                    ...
                                    <td class="text-center" style="width: 50px;">
                                        <a href="{{ url('admin/blog/view/' . $value->id) }}" class="dropdown-item align-items-center">
                                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                                 viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                 stroke-width="2" stroke-linecap="round" stroke-linejoin="round"
