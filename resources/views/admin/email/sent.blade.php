                  ...
                  <div class="row align-items-center">
                    <div class="col-lg-6">
                      <div class="d-flex align-items-end mb-2 mb-md-0">
                        ...
                        <span class="text-muted">({{ $getRecord->count() }} new messages)</span>
                      </div>
                    </div>
                    <div class="col-lg-6">
                ...
                <div class="p-3 border-bottom d-flex align-items-center justify-content-between flex-wrap">
                  <div class="d-none d-md-flex align-items-center flex-wrap">
                    ...
                    <div class="btn-group me-2">
                      ...
                      <a href="" onclick="return confirm('Are you sure you want to delete?')" id="getDeleteUrl" class="btn btn-outline-primary">Delete</a>
                    </div>
