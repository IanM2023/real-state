            ...
            <div class="card-body">
                ...
                <form class="forms-sample" method="POST" action="{{ url('admin/address/add') }}">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="" id="country_v" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="" id="state_v" required>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-9">
                            <select class="form-control" name="" id="city_v" required>
                    ...
                    <div class="row mb-3">
                        <label class="col-sm-3 col-form-label">Address Name <span style="color: red;"> *</span></label>
                        <div class="col-sm-9">
                            <input type="text" name="address_name" class="form-control" placeholder="Enter Address Name" required>
